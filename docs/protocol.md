...
介面；也不依賴 `disable_screen_share_protections_for_apps_and_notifications` 之類的系統 setting，
因為這些 key 在不同 Android / OEM build 上不一定生效，寫入成功也不代表 MediaProjection policy 會即時重讀。
